    ...
    <section className="relative overflow-hidden rounded-3xl border border-slate-700/50 bg-slate-900/40 shadow-2xl shadow-blue-950/20">
      ...
      <div className="absolute inset-0">
        <img
          ...
          decoding="async"
        />
        <div className="absolute inset-0 bg-gradient-to-r from-[#020617]/25 via-[#020617]/15 to-[#020617]/10 sm:to-transparent" />
        <div className="absolute inset-0 bg-gradient-to-t from-[#020617]/15 via-transparent to-transparent" />
      </div>
